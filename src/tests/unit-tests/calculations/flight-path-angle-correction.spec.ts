...
test.each([
    { uncorrected_flight_path_angle: 3, aerodrome_elevation_ft: 200, ground_temperature_degC: -40, input_altitude_ft: 5000, assertion_corrected_flight_path_angle: 3.5775 },
    { uncorrected_flight_path_angle: 3, aerodrome_elevation_ft: 1000, ground_temperature_degC: -70, input_altitude_ft: 5000, assertion_corrected_flight_path_angle: 3.8802 },
    { uncorrected_flight_path_angle: 4.5, aerodrome_elevation_ft: 1000, ground_temperature_degC: -70, input_altitude_ft: 5000, assertion_corrected_flight_path_angle: 5.81584 }, 
